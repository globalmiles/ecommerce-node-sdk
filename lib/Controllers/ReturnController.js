...
class ReturnController {
    ...
    static retrieveReturn(returnProvisionToken, callback) {
        ...
        let _pathUrl = '/v1/ecommerce/returns/{return_provision_token}';
        ...
        return _oAuthManager.authorize().then(
            () => ReturnController.retrieveReturnAction(_queryUrl, _callback),
            (err) => {
    ...
    static deleteCancelReturn(body, callback) {
        ...
        const _pathUrl = '/v2/ecommerce/returns';
        const _queryBuilder = `${_baseUri}${_pathUrl}`;
        ...
        return _oAuthManager.authorize().then(
            () => ReturnController.deleteCancelReturnAction(_queryUrl, _callback, body),
            (err) => {
                _callback(err, null, null);
                return Promise.reject(err);
            });
    ...
    static updateCompleteReturn(body, callback) {
        ...
        return _oAuthManager.authorize().then(
            () => ReturnController.updateCompleteReturnAction(_queryUrl, _callback, body),
            (err) => {
                _callback(err, null, null);
                return Promise.reject(err);
            });
    ...
    static createStartReturn(body, callback) {
        ...
        return _oAuthManager.authorize().then(
            () => ReturnController.createStartReturnAction(_queryUrl, _callback, body),
            (err) => {
                _callback(err, null, null);
                return Promise.reject(err);
            });
    ...
    static listReturns(filterStoreCode, filterCreatedAt, filterStatus, sort, callback) {
        ...
        if (_oAuthManager.isTokenSet()) {
            return ReturnController.listReturnsAction(
                _queryUrl,
                _callback,
                filterStoreCode,
                filterCreatedAt,
        ...
        return _oAuthManager.authorize().then(
            () => ReturnController.listReturnsAction(
                _queryUrl,
                _callback,
                filterStoreCode,
                filterCreatedAt,
