...
class ReturnController {
     ...
     * @returns {Promise}
     */
    static createStartReturn(accept, contentType, authorization, body, callback) {
     ...
     * @returns {Promise}
     */
    static updateCompleteReturn(accept, contentType, authorization, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static deleteCancelReturn(accept, contentType, authorization, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
