...
class EarnMilesPointsController {
    /**
     * This endpoint allows to create an order for earn a miles / points. It may also include
     ...
     * @returns {Promise}
     */
    static createOrderInfo(accept, contentType, authorization, body, callback) {
    ...
    /**
     * This endpoint allows to get available amount of money, based on miles / points of user and
     * their discounts which is based on cart or items.
     *
     * @param {string} accept It advertises which content type is able to understand.
     * @param {string} contentType It tells the client what the content type of the returned.
     * @param {string} authorization It includes OAuth2 token.
     ...
     * @returns {Promise}
     */
    static createCartInfo(accept, contentType, authorization, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
...
module.exports = EarnMilesPointsController;
