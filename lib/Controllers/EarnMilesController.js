...
class EarnMilesController {
    ...
    static listOrders(filterStoreCode, filterCompletedAt, filterStatus, sort, callback) {
        ...
        let _queryBuilder = `${_baseUri}${'/v2/ecommerce/orders'}`;
        ...
        if (!tokenSet) {
            ...
            oAuthPromise.then(() => {
                return EarnMilesController.listOrdersAction(_queryUrl, _callback, filterStoreCode, filterCompletedAt, filterStatus, sort);
            }, (err) => {
    ...
    static listOrdersAction(_queryUrl, _callback, filterStoreCode, filterCompletedAt, filterStatus, sort) {
    ...
    static retrieveOrder(transactionId, callback) {
        ...
        let _queryBuilder = `${_baseUri}${'/v2/ecommerce/orders/{transaction_id}'}`;
