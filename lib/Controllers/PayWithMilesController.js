...
class PayWithMilesController {
    ...
    static listMilePayments(filterStoreCode, filterCreatedAt, filterStatus, sort, callback) {
        ...
        if (!tokenSet) {
            ...
            oAuthPromise.then(() => {
                return PayWithMilesController.listMilePaymentsAction(_queryUrl, _callback, filterStoreCode, filterCreatedAt, filterStatus, sort);
            }, (err) => {
    ...
    static listMilePaymentsAction(_queryUrl, _callback, filterStoreCode, filterCreatedAt, filterStatus, sort) {
