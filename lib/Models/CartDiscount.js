...
/**
 * Creates an instance of CartDiscount
 */
class CartDiscount extends BaseModel {
    ...
    constructor(obj) {
        ...
        this.discountProvisionToken =
          this.constructor.getValue(obj.discountProvisionToken
     || obj.discount_provision_token);
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'discountProvisionToken', realName: 'discount_provision_token' },
            { name: 'items', realName: 'items', array: true, type: 'CartItemDiscount' },
        ]);
    }
